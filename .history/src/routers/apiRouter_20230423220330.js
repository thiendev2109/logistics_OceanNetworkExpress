...
const initialApiRouter = (app) => {
  ...
  //merchandiseType
  router.post('/merchandise-type', serviceController.createService);
  router.get('/merchandise-type', serviceController.getAllServices);
  router.get('/merchandise-type:id', serviceController.getService);
  router.put('/merchandise-type/:id', serviceController.updateService);
  router.delete('/merchandise-type/:id', serviceController.deleteService);
