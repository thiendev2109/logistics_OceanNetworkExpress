...
const initialApiRouter = (app) => {
  ...
  router.get('/employee', employeeController.getAllVehicals);
  router.get('/employee:id', employeeController.getVehical);
  router.put('/employee:id', employeeController.updateVehical);
  router.delete('/employee:id', employeeController.deleteVehical);
